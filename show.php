...
$res1=mysql_query($q1) or die(" again");
$row1=mysql_fetch_assoc($res1);
if($row1!=""){	$value='UNFOLLOW';}
else{$value='FOLLOW';}
$q2="select * from wishlist where Show_Id=$id and User_Id=$user;";
$res2=mysql_query($q2) or die(" again");
$row2=mysql_fetch_assoc($res2);
if($row2 != ""){$value2='Remove From Wishlist';}
else{$value2='Add to wishlist';}
}
else{$value='FOLLOW SHOW';$value2="Add to Your wishlist";}
 ...
 <div id="main-nav" class="collapse navbar-collapse" align="center" style="text-align:center" style="">
  <ul class="nav navbar-nav" id="mainNav" >
   <li class="active" id="firstLink" ><a href="#home" class="scroll-link"><font size="+1"><b><?php echo $name; ?></b></font></a></li>
       ...
       <?php if(isset($_SESSION['status'])) {?><li><a href="#reviews" class="scroll-link">Reviews</a></li><?php } ?>
	     <li> <?php
...
<section id="aboutUs">
  ...
  <div class="row feature design">
      <div class="area1 columns right">
       ...
       <input type="button" class="btn btn-lg btn-primary" id="wishlist" value="<?php echo $value2;?>"/>
...
if(isset($_SESSION['status'])) {?>
<section  style="background-color:#fff" id="reviews">
...
if(count($comments) > 0){echo'<h1>User Reviews</h1>';}
